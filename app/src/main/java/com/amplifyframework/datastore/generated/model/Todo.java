...
public final class Todo implements Model {
  ...
  public static final QueryField PROGRESS = field("progress");
  ...
  public final @ModelField(targetType="String") String progress;
  public String getId() {
      return id;
  }
  ...
  private Todo(String id, String name, String description, String progress) {
    this.id = id;
    this.name = name;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), todo.getId()) &&
              ...
              ObjectsCompat.equals(getProgress(), todo.getProgress());
      }
  }
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, String description, String progress) {
      super.id(id);
      super.name(name)
